...
@section('breadcrumbs')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('Candidate.admin.index') }}">Daftar Kandidat</a></li>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <div class="d-flex justify-content-end">
                <a href="{{ route('Candidate.admin.index') }}" class="btn btn-secondary"
                    style="margin-right: 5px;">Kembali</a>
                <a href="{{ route('Candidate.admin.edit', $candidate->uuid) }}" class="btn btn-primary"
                    style="margin-right: 5px;">Edit</a>
                <form action="{{ route('Candidate.admin.destroy', $candidate->uuid) }}" method="POST"
