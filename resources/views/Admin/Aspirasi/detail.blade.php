...
@section('breadcrumbs')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('aspiration.admin.index') }}">Daftar Aspirasi</a></li>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <div class="d-flex justify-content-end">
                <a href="{{ route('aspiration.admin.index') }}" class="btn btn-secondary mr-2">Kembali</a>
            </div>
        </div>
    </div>
@endsection
