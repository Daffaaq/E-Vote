            ...
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-md-12 text-end">
                        <a href="{{ route('jadwal.admin.create') }}" class="btn btn-primary">Tambah Jadwal</a>
                    </div>
                </div>
                                ...
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-content">
                                        ...
                                        <div class="d-flex justify-content-start mt-2">
                                            <a href="{{ route('jadwal-orasi.admin.edit', $jo->uuid) }}"
                                                class="btn btn-warning btn-sm me-2">Edit</a>
                                            <form action="{{ url('dashboardAdmin/Jadwal/destroy/orasi/' . $jo->uuid) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn btn-danger btn-sm"
                            ...
                            @forelse ($jadwalVotes as $jv)
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-content">
                                        ...
                                        <div class="d-flex justify-content-start mt-2">
                                            <a href="{{ route('jadwal-votes.admin.edit', $jv->uuid) }}"
                                                class="btn btn-warning btn-sm me-2">Edit</a>
                                            <form action="{{ url('dashboardAdmin/Jadwal/destroy/votes/' . $jv->uuid) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn btn-danger btn-sm"
                            ...
                            @forelse ($jadwalResultVote as $jrv)
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-content">
                                        ...
                                        <div class="d-flex justify-content-start mt-2">
                                            <a href="{{ route('jadwal-result.admin.edit', $jrv->uuid) }}"
                                                class="btn btn-warning btn-sm me-2">Edit</a>
                                            <form action="{{ url('dashboardAdmin/Jadwal/destroy/result/' . $jrv->uuid) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn btn-danger btn-sm"
                ...
                @else
                    <div class="empty-state d-flex flex-column align-items-center">
                        ...
                        <a href="{{ route('jadwal.admin.create') }}" class="btn btn-success mt-2">Tambah Jadwal
                            Sekarang</a>
                    </div>
                @endif
