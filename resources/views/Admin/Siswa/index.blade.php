...
@section('content')
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="importForm" action="{{ route('siswa.admin.import') }}" method="POST"
    ...
    <script>
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data) {
                            return `
                                <a href="/dashboardAdmin/Siswa/edit/${data}" class="btn icon btn-sm btn-warning">
                                    <i class="bi bi-pencil"></i>
                                </a>
                                <a href="/dashboardAdmin/Siswa/show/${data}" class="btn icon btn-sm btn-info">
                                    <i class="bi bi-eye"></i>
                                </a>
        ...
        function confirmDelete(uuid) {
            $('#deleteForm').attr('action', `/dashboardAdmin/Siswa/destroy/${uuid}`);
