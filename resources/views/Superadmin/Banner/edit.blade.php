                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('banner.update', $banner->id) }}"
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-6">
                                    <input id="title" type="text"
                                        ...
                                        value="{{ old('title', $banner->tittle) }}" required autofocus>
                                    @error('title')
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-6">
                                    <textarea id="description" class="form-control @error('description') is-invalid @enderror" name="description" required>{{ old('description', $banner->desc) }}</textarea>
                                    @error('description')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="mb-3 row">
                                    <div class="col-md-6 offset-md-4">
                                        <img src="{{ asset('storage/' . $banner->image) }}" alt="Current Image"
                                            class="img-fluid mt-3" id="imagePreview">
                                    </div>
                                </div>
                            @endif
